...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" aria-label="Tenth navbar example">
    ...
    <div class="container-fluid">
        <center><p class="display-1">Busca de Produtos</p></center>
        ...
        <th>Total</th>
            ...
            <?Php
                ...
                $busca = $_POST['produto'];
                $sqliselect = "SELECT * FROM  $table WHERE produto='$busca'";
                ...
                $total_valores = "SELECT SUM(total) AS num FROM produtos WHERE produto = '$busca'";
                $soma_total = 0;
...
<button type="button" class="btn btn-warning" onclick="excluir()">EXCLUIR</button>


<form nome="inicio" action="excluir_conf.php" method="post" id="excluir">
      <input type="hidden" name="off" value ="<?php $busca ?>" id="1">
      <input type="hidden" name="produto" value = "<?php echo $busca?>" id="">
</form>
