...
<head>
    ...
    <body class="one">
        ...
        <script>
            function verifica1() {
              var controle = document.querySelector("[name='produto']").value;
        ...
        <div class="position-absolute top-50 start-50 translate-middle">
            <div class="global-container">
                <div class="card login-form">
                    <div class="card-body">
                        <center><h1 class="card-title">Excluir Produto</h1></center>
                        <form nome="inicio" action="dados/excluir.php" method="post" id="www">
                            <div class="form-group" id="">
                                <center><label for="text">Nome do produto</label></center>
                                <input type="text" name="produto" id="ex"
                                class="form-control form form-control-sm">
                            </div>

                            <button type="button" class="btn btn-danger" onclick="verifica1()">Exluir produto</button>
                        </form>
                    </div>
                </div>
              </div>
